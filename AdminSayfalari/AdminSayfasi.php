...
<head>
    ...
    <link rel="stylesheet" href="css/AracYonetimi.css"> <!-- Harici CSS dosyası -->
</head>
<body>
    <div class="sidebar">
        <h2>Admin Paneli</h2>
    ...
    <div class="content">
        <h2>Araç Yönetimi</h2>
        <a href="AracEkle.php" class="add-button">Yeni Araç Ekle</a> <!-- Yeni araç ekleme butonu -->
        ...
        <form method="POST" action="">
            ...
            <div class="card-container">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<br>";                    
                    echo "<button type='button' onclick=\"window.location.href='aracDuzenle.php?id=" . $row['Arac_id'] . "'\" class='edit-button'>Aracı Düzenle</button>"; // Her araç için aracı düzenleme butonu
                    echo "</div>";
                    echo "</div>";
                }
                ?>
